...
<form class="form-horizontal" action="create.php" method="post">
	...
	<div class="control-group <?php echo !empty($mem_lnameError)?'error':'';?>"><br>
	...
	<div class="control-group <?php echo !empty($mem_emailError)?'error':'';?>"><br>
	...
	<div class="control-group <?php echo !empty($mem_cell_numberError)?'error':'';?>"><br>
	...
	<div class="control-group <?php echo !empty($mem_typeError)?'error':'';?>"><br>
